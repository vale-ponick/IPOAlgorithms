...
struct BridgeScannersEnterprise {
    static func run() {
        ...
        // MARK: - 2. ⚙️ USS Enterprise вышел на орбиту неизученной планеты класса М. 🔭 Вы — научный сотрудник у консоли сенсоров. Атмосферные и энергетические условия на планете постоянно меняются. Ваша задача ➡️ мгновенно категоризировать состояние аномалий и автоматически отправлять рекомендации капитану Кирку.
