...
//  🪐 Задача 1: Сканеры мостика
//  🌳 Дерево решений добавлено для визуализации логики
//  🌌🛸 + 🚕💨 Стиль: Звёздный Путь + жёлтое такси
...
struct BridgeScannersEnterprise {
    static func run() {
        ...
        // MARK: - 🌳 ДЕРЕВО РЕШЕНИЙ (Decision Tree)
        //
        //                        🌌🛸 КОСМИЧЕСКАЯ КАРТА
        //                               |
        //               ┌───────────────┼───────────────┐
        //               |               |               |
        //            ☀️ .clear       ⛈️ .storm       🌫️ .nebula
        //               |               |               |
        //         ┌─────┴─────┐   ┌─────┴─────┐         |
        //         |           |   |           |         |
        //      ⚠️ r > 50?  🟢 ≤50  🚨 d > 80%? 🟡 ≤80%   ☁️ туман
        //         |           |   |           |         |
        //   Радиация    Стабильно  Красный   Желтый     Контакт
        //   повышена    высадка    код       код        потерян
